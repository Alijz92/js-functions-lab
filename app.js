...
const basicCalculator = (n1, n2, string) => {
  if (string === 'add') {
    return n1 + n2
...
const createUsername = (firstName, lastName) => {
  ...
  return firstName.substring(0, 3) + lastName.substring(0, 3) + characterCount
}
